...
class TestMaskData < Test::Unit::TestCase
  ...
  def test_convolution
    ...
    e = RBA::Edge::new(0, 0, 1000, 0)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-100,100;1100,100;1100,-100)]")

    e = RBA::Edge::new(0, 0, 0, 1000)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-100,1100;100,1100;100,-100)]")

    e = RBA::Edge::new(0, 0, 1000, 1000)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-100,100;900,1100;1100,1100;1100,900;100,-100)]")

    e = RBA::Edge::new(0, 0, -500, 1000)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-600,900;-600,1100;-400,1100;100,100;100,-100)]")

    e = RBA::Edge::new(-1000, 500, 0, 0)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-1100,400;-1100,600;-900,600;100,100;100,-100)]")
  ...
  def test_convolution_1d
    ...
    e = RBA::Edge::new(0, 0, 1000, 0)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-100,100;900,100;900,-100)]")

    e = RBA::Edge::new(0, 0, 0, 1000)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[]")

    e = RBA::Edge::new(0, 0, 1000, 1000)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-100,100;900,1100;900,900)]")

    e = RBA::Edge::new(0, 0, -500, 1000)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-600,900;-600,1100;-100,100)]")

    e = RBA::Edge::new(-1000, 500, 0, 0)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(-100,-100;-1100,400;-1100,600;-100,100)]")

  end
 
  def test_convolution_neg

    pts = []
    pts << RBA::Point::new(100, -100)
    pts << RBA::Point::new(-100, 0)
    pts << RBA::Point::new(100, 100)
    pts << RBA::Point::new(-100, 100)
    pts << RBA::Point::new(100, 0)
    pts << RBA::Point::new(-100, -100)
    ...
    e = RBA::Edge::new(0, 0, 1000, 0)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(100,-100;-100,0;100,100;900,100;1100,0;900,-100)]")

    e = RBA::Edge::new(0, 0, 0, 1000)
    assert_equal(XS::MaskData.produce_edge_with_kernel(e, pts).to_s, "[(0,-50;-100,0;-100,1000;0,1050;100,1000;100,0)]")
